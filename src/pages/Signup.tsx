...
import { Mail, Lock, User, Crown, Loader2, ArrowRight, Users, Calendar, Trophy, MessageSquare } from 'lucide-react';
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 w-full">
          ...
          >
            ...
            <h1 className="text-5xl font-display font-bold text-white mb-6 leading-tight">
              Find Your Next
              <br />
              <span className="text-gold-400">Chess Match</span>
            </h1>

            <p className="text-xl text-white/70 mb-12 leading-relaxed">
              Join the community of chess players connecting for games at venues worldwide.
            </p>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-chess-darker">
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-white/60">Start connecting with chess players today</p>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-white/50">
            ...
            <a href="/terms" className="text-gold-400 hover:text-gold-300 transition-colors">
              Terms of Service
            </a>
            {' '}and{' '}
            <a href="/privacy" className="text-gold-400 hover:text-gold-300 transition-colors">
              Privacy Policy
            </a>
          </p>
