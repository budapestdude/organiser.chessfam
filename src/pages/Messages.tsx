...
import { ArrowLeft, Send, MessageSquare, User, Loader2, Bell } from 'lucide-react';
...
const Messages = () => {
  ...
  const [activeTab, setActiveTab] = useState<'messages' | 'notifications'>(
    tabParam as 'messages' | 'notifications'
  );
  const {
    user,
    apiConversations,
    ...
    <div className="min-h-screen py-8 px-4 md:px-8 max-w-6xl mx-auto">
      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <h1 className="text-2xl font-display font-bold text-white">Messages & Notifications</h1>
          <div className="w-16" />
        </div>
